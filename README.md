...
The dashboard, its emails and its notification payloads are translated. Nine locales ship:
...
```ruby
config.dashboard_locale = "de"  # en, de, es, fr, pt-BR, ja, ru, uk, pl — default "en"
```
