...
# Pre-release test v2: ALL features enabled, sync, shared DB
# Used for the HTTP error capture app (Phase F)
RailsErrorDashboard.configure do |config|
  ...
  # Custom severity rules — CustomTestError is raised by test controller
