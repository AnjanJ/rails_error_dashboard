...
# Pre-release test: Async logging via SolidQueue adapter path
# ActiveJob queue_adapter is set to :async (Rails thread pool) in a separate
# initializer, so no SolidQueue infrastructure is needed. This tests the
